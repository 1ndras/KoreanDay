...
public class SoalActivity extends Activity {
	...
	private static String url = "http://192.168.1.99/koreanday/soal.php";
	...
	private class GetSoal extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			pDialog = new ProgressDialog(SoalActivity.this);
	...
	private OnClickListener klikSelesai = new OnClickListener() {
		public void onClick(View v) {
			...
			tampilKotakAlert = new AlertDialog.Builder(SoalActivity.this)
					.create();
