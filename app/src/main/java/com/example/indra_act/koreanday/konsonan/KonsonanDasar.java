...
public class KonsonanDasar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expandableListView = (ExpandableListView) findViewById(R.id.expandableListKonsonan);
        expandableListDetail = ListdataKonsonanDasar.getData();
